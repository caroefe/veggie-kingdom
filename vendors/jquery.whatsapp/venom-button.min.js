!function($) {
    ...
    $.fn.venomButton = function(options) {
        ...
        $button.addClass("venom-button-button").append($(settings.buttonImage)).css({
            width: settings.size,
        ...
        settings.showPopup) {
            ...
            $header.append("<span>" + settings.headerTitle + "</span>", $closeBtn).css("background-color", settings.headerColor),
